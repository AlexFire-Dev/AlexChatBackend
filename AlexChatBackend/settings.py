"""
Django settings for AlexChatBackend project.
...
SECRET_KEY = 'django-insecure-t&wh^ipce47nty8*l3!%l465_@75f=7s6hcmgh!yru=94n9r-$'
...
ROOT_URLCONF = 'AlexChatBackend.urls'
